...
import com.vehiclefleetsimulator.vehiclefleetsimulator.core.*;
...
//                double dist = Math.sqrt(yDist * yDist + xDist * xDist);
                ...
                double otherHalfW = (other.getAllignment() == Alignment.HORIZONTAL) ? other.getLength()/2 : other.getWidth()/2; /*other.length/2 : other.width/2;*/
                double otherHalfL = (other.getAllignment() == Alignment.HORIZONTAL) ? other.getWidth()/2 : other.getLength()/2; /*other.width/2 : other.length/2;*/
