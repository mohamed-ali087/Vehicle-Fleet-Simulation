// Map.java
package com.vehiclefleetsimulator.vehiclefleetsimulator.map;

import com.vehiclefleetsimulator.vehiclefleetsimulator.core.Block;
import com.vehiclefleetsimulator.vehiclefleetsimulator.core.Directions;
import com.vehiclefleetsimulator.vehiclefleetsimulator.core.TurningPoint;
...
//    public static final double AIR_SPAWN_Y    = mapHeight / 2;
    ...
    ImageView seaBG    = new ImageView(new Image(Objects.requireNonNull(getClass().getResourceAsStream("Assets/sea.png"))));
    ImageView roadBG   = new ImageView(new Image(Objects.requireNonNull(getClass().getResourceAsStream("Assets/road.png"))));
    ImageView airportBG= new ImageView(new Image(Objects.requireNonNull(getClass().getResourceAsStream("Assets/airport.png"))));

    Building building1 = new Building(950, 300, 250, 250, new Image(Objects.requireNonNull(getClass().getResourceAsStream("Assets/building.png"))));
    Building building2 = new Building(950, 700, 250, 250, new Image(Objects.requireNonNull(getClass().getResourceAsStream("Assets/building.png"))));
...
//                    500, Directions.RIGHT, TurningPoint.Type.HOLD_ALT, 0)
    ...
    public static class Barrier extends Block {
        ...
        public static final Image BARRIER_IMAGE =
                new Image(Objects.requireNonNull(Map.class.getResourceAsStream("Assets/barrier.png")));
        public static final Image SEA_BARRIER_IMAGE =
                new Image(Objects.requireNonNull(Map.class.getResourceAsStream("Assets/seaBarrier.png")));
